package br.com.battlebits.ybattlecraft.nms.barapi;
...
/**
 * This is the FakeDragon class for BarAPI. It is based on the code by
 * SoThatsIt.
 * 
 * http://forums.bukkit.org/threads/tutorial-utilizing-the-boss-health-bar
 * .158018/page-5#post-2053705
 * 
...
public class v1_8Fake extends FakeDragon {
	...
	public Object getTeleportPacket(Location loc) {
		...
		Object packet = null;
		try {
			packet = PacketPlayOutEntityTeleport.getConstructor(new Class<?>[] { int.class, int.class, int.class, int.class, byte.class, byte.class, boolean.class, boolean.class }).newInstance(this.id, loc.getBlockX() * 32, loc.getBlockY() * 32, loc.getBlockZ() * 32, (byte) ((int) loc.getYaw() * 256 / 360), (byte) ((int) loc.getPitch() * 256 / 360), false, true);
		} catch (IllegalArgumentException e) {
			e.printStackTrace();
		} catch (SecurityException e) {
			e.printStackTrace();
